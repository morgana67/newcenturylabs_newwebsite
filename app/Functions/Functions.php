...
class Functions {
    ...
    public static function replaceBodyEmail($body,$customer) {
        ...
        $body = str_replace("{{LOGO}}", '<p style="margin-top:0in;text-align:center" align="center"><img src="'.str_replace('%5C','/',image(setting('site.logo'))).'" alt="'.setting('site.title').'" border="0" ></p>', $body);
        return $body;
    }
