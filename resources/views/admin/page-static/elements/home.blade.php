    ...
    <div>
        ...
        <div class="form-group col-md-4">
            ...
            @if(!empty($body->img_icon_1_section1))
                <img src="{{$body->img_icon_1_section1}}" alt="">
            @endif
{{--        </div>--}}
    </div>
    <div>
        ...
        <div class="form-group col-md-4">
            ...
            @if(!empty($body->img_icon_2_section1))
                <img src="{{$body->img_icon_2_section1}}" alt="">
            @endif
        </div>
    </div>
    ...
    <div>
        ...
        <div class="form-group col-md-4">
            ...
            @if(!empty($body->img_icon_3_section1))
                <img src="{{$body->img_icon_3_section1}}" alt="">
            @endif
        </div>
    </div>
    <hr>
    ...
    <div class="form-group col-md-12">
        ...
        @if(!empty($body->image_section3))
            <img src="{{$body->image_section3}}" alt="">
        @endif
    </div>
    ...
    <div class="form-group col-md-12">
        ...
        @if(!empty($body->image_section4))
            <img src="{{$body->image_section4}}" alt="">
        @endif
    </div>
</div>
